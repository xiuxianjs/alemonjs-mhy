...
var router = defineRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                handler: lazy(() => import('./response/mihoyo/bindStoken.js'))
            },
            {
            ...
            },
            {
                ...
                handler: lazy(() => import('./response/mihoyo/gameSign.js'))
            },
            {
                regular: mihoyoRouteRules.bbsSign,
                handler: lazy(() => import('./response/mihoyo/bbsSign.js'))
            },
            {
                regular: mihoyoRouteRules.qrLogin,
                handler: lazy(() => import('./response/mihoyo/qrLogin.js'))
            },
            {
                regular: mihoyoRouteRules.useCode,
                handler: lazy(() => import('./response/mihoyo/useCode.js'))
            },
            {
                regular: mihoyoRouteRules.sevenSaints,
                handler: lazy(() => import('./response/mihoyo/sevenSaints.js'))
            },
            {
                regular: mihoyoRouteRules.birthday,
                handler: lazy(() => import('./response/mihoyo/birthday.js'))
            },
            {
                regular: mihoyoRouteRules.payLog,
                handler: lazy(() => import('./response/mihoyo/payLog.js'))
            },
            {
