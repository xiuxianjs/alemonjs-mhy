            ...
            React.createElement("div", { style: { ...styles.header, background: theme.gradient } },
                React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                    ...
                    React.createElement("div", null,
                        React.createElement("div", { style: { fontSize: '18px', fontWeight: 'bold', color: theme.headerText } }, info.name),
                        React.createElement("div", { style: { fontSize: '12px', color: theme.headerSub } }, month))),
